...
function theme_asset($asset) {
    echo wp_make_link_relative(get_bloginfo('stylesheet_directory') .'/dist/'.$asset);
}
...
if( !is_admin()){
    ...
    wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/dist/scripts/modernizr.js', array(), '2.5.2', false );
}
