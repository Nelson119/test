			...
			<ul>
				...
				<li data-background-image="<?php theme_asset('images/videos/kv.png?i='.$i)?>">
					<article>
						...
						<a class="link" href="javascript:"><img src="<?php theme_asset('images/common/goto.svg')?>"></a>
					</article>
				</li>
				<?php endwhile?>
			</ul>
...
<div class="container">
    <section class="row">
		...
		<section class="col-lg-6">
			<figure>
				<a href="javascript:" style="background-image: url(<?php theme_asset('images/videos/thumb.png')?>)"></a>
			</figure>
			<section class="detail">
				...
				<a class="link" href="javascript:">
					<svg viewBox="0 0 19 14">
						<path id="XMLID_469_" class="st0" d="M18.7,6.4l-5.7-5.7c-0.3-0.3-0.9-0.3-1.2,0c-0.3,0.3-0.3,0.9,0,1.2L16,6.1H0.9 C0.4,6.1,0,6.5,0,7c0,0.5,0.4,0.9,0.9,0.9H16L11.8,12c-0.3,0.3-0.3,0.9,0,1.2c0.2,0.2,0.4,0.3,0.6,0.3c0.2,0,0.5-0.1,0.6-0.3 l5.7-5.7C19.1,7.3,19.1,6.7,18.7,6.4z"/>
					</svg>
				</a>
			</section>
		</section>
