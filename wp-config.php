 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'hv)CU~MW#`[&`y|Qv3_cN$Jb{!&5[H89!RhcPkAF:FHnvK77(9[@-:C&zo-1?c>a');
define('SECURE_AUTH_KEY',  'p ^%>rm-j?-:2#ifCets/qGo-daVxHvkD39xH@.^j}cb{kn,K|C8=l!*qv?h/+dx');
define('LOGGED_IN_KEY',    ']%YPB-[Y|yz<WS`88|w!sH?nv ;k-^%Nbn)_#11xTP+6#8rG.9D +Ti9T[@ Q(pI');
define('NONCE_KEY',        '{b-$4ad3D.7qxB%$YaTbdarn+*-Z{&4:%-6fCDLWDnYiAKn>$2e4u;1<(!P;A6P0');
define('AUTH_SALT',        '=[/6%f158dld;Nq)GNv?bgubaYaw@a(V&?~mx@`%(EB=|K4?xH.tl<vW6[J./IK_');
define('SECURE_AUTH_SALT', 'yzdv6(|5Ea=]@@}D^C[;*@C_|9B:>VA:^ /7j<Y.Md)Kqibt4DSNAL[0$ ImQ@(d');
define('LOGGED_IN_SALT',   'ITH f?#fG;t2]tdire_[VyabG[-qcvdc4N]IDIqdpFU5)R4(lyZ`{2iolG1USE:~');
define('NONCE_SALT',       'nGH:tn-2}KeJ,+QPi3FZ*ybh|Hv.8>XI/J2W40z8.r4iY:F/m~|#c_Cw>LQ31#gs');
